...
@section('content')
    {{-- <div>
        <h3>Login Page</h3> --}}
    {{-- diambil dari with('error') userscontroller --}}
    ...
    <div class="mx-auto py-12 my-12 px-4 sm:px-6 lg:px-8 max-w-sm rounded shadow-lg">
        <div class="max-w-md w-full space-y-8">
            <div>
                <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Login to Admin Account</h2>
                <p class="mt-2 text-center text-sm text-gray-600">
                    Or
                    <a href="/register" class="font-medium text-green-600 hover:text-green-500"> Register with new admin
                        account
                    </a>
                </p>
            </div>
            <form class="mt-8 space-y-6" action={{ route('login_action') }} method="POST">
                @csrf
